...
$after_assoc_blog_details = mysqli_fetch_assoc($select_blog_details_result);
?>
<!doctype html>
<html lang="en">
  <head>
   ...
   <div class="click-capture d-lg-none"></div>
      ...
      <div class="d-flex position-relative w-100">
        ...
        <a class="navbar-brand" href="#">
          ...
          <ul class="navbar-nav-desctop mr-auto d-none d-lg-block">
            <li><a class="nav-link" href="http://localhost/vespa/">Home</a></li>
    ...
    <section style="padding: 100px 0;">
      ...
      <div class="row" style="margin-bottom: 30px;">
            <div class="col-md-6 m-auto text-center" data-aos="fade-up"><h2 class="mb-3 mb-md-0">Blog Details</h2></div>
        </div>
        <div class="row">
          <div class="col-lg-12">
            <h3  data-aos="fade-up" style="margin: 0;"><?= $after_assoc_blog_details['title']?></h3>
            <span style="margin-bottom: 10px;"><?= $after_assoc_blog_details['created_at']?></span>
            <img width="100%" src="uploads/blogs/<?= $after_assoc_blog_details['image']?>" alt="">
            <p  data-aos="fade-up" style="margin-top: 30px;"><?= $after_assoc_blog_details['description']?></p>
          </div>
        </div>
      </div>
    </section>
