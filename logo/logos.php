...
<?php 
require '../db.php';
$select_banners = "SELECT * FROM logos";
                    ...
                    <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <img width="50" src="../uploads/logos/<?= $banners['logo']?>" alt="<?= $banners['logo']?>">
                            </td>
                            <td>
                              <?php if($banners['status']==1) {?>
                                <a href="logo_status.php?id=<?= $banners['id']?>" class="btn btn-danger">Active</a>
                                <?php } else {?>
                                  <a href="logo_status.php?id=<?= $banners['id']?>" class="btn btn-secondary">Deactive</a>
                                  <?php }?>
                            </td>
                            <td>
